...
client = Client()
examples = list(
    client.list_examples(dataset_name="ds-unnatural-molecule-62", limit=200)
)
...
client.create_examples(
    ...
    examples=[
        {"inputs": {**example.inputs, **example.outputs}, "metadata": example.metadata}
    ...
    if "messages" in inputs and isinstance(inputs["messages"], list):
        ...
        for msg in inputs["messages"]:
            if isinstance(msg, dict):
                ...
                clean_msg = {"type": msg.get("type"), "content": msg.get("content")}
