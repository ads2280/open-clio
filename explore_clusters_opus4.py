...
def load_demo_data() -> Dict[str, pd.DataFrame]:
    ...
    return {
        ...
        'examples': pd.read_csv('experiment_results/opus4-500-25-6/20250626_141203_examples.csv'),
        'level_0': pd.read_csv('experiment_results/opus4-500-25-6/20250626_141203_level_0_clusters.csv'),
        'level_1': pd.read_csv('experiment_results/opus4-500-25-6/20250626_141203_level_1_clusters.csv')
