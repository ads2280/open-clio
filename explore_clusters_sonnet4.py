# be able to explore sonnet 3.5, opus 4, sonnet 4
...
def load_demo_data() -> Dict[str, pd.DataFrame]:
    ...
    return {
        # original:
        # sonnet 4
        "linked_examples": pd.read_csv(
            "experiment_results/sonnet3.5-500-16-8/raw_examples_2.csv"
        ),
        "examples": pd.read_csv(
            "experiment_results/sonnet4.0-500-25-5/20250625_175327_examples.csv"
        ),
        "level_0": pd.read_csv(
            "experiment_results/sonnet4.0-500-25-5/20250625_175327_level_0_clusters.csv"
        ),
        "level_1": pd.read_csv(
            "experiment_results/sonnet4.0-500-25-5/20250625_175327_level_1_clusters.csv"
        ),
    }
...
def main():
    ...
    st.markdown(
        "Explore ~500 LangChain conversations organized into hierarchical clusters. You can navigate from 8 high-level topic areas down to 16 specific clusters, then to conversation summaries, and finally to full Chat LangChain threads."
    )
