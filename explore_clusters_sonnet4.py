...
def load_demo_data() -> Dict[str, pd.DataFrame]:
    ...
    return {
        ...
        'examples': pd.read_csv('experiment_results/sonnet4.0-500-25-5/20250625_175327_examples.csv'),
        'level_0': pd.read_csv('experiment_results/sonnet4.0-500-25-5/20250625_175327_level_0_clusters.csv'),
        'level_1': pd.read_csv('experiment_results/sonnet4.0-500-25-5/20250625_175327_level_1_clusters.csv')
