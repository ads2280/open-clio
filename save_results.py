...
def save_results(
    ...
    extract_product=None, extract_issue_type=None  # Add these parameters
):
    ...
    df_examples = df_examples.sort_values('cluster_size', ascending=False) #added - biggest clusters at top
    ...
    for level in range(max_level + 1):
        ...
        df_level = df_level.sort_values('size', ascending=False) #added - biggest clusters at top
