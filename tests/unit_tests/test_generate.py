...
from open_clio.generate import (
    ...
    generate_single_cluster_description,generate_clusters
)
...
class TestGenerateNeighborhoods:
    def test_generate_neighborhoods(self):
        ...
        neighborhood_labels, k_neighborhoods = generate_neighborhoods(cluster_embeddings, num_clusters)
    ...
    def test_generate_neighborhoods_small_ds(self);
